...
/**
  * @ClassName: CollegeVo2EntityConverter
  * @Description: 员工转换器，Vo->Entity
  * @author heliqiang@xbniao.com
  * @date 2016年2月5日 上午11:17:57
  *
*/
public class CollegeVo2EntityConverter implements Converter {
	...
	/**
	  * @Fields LOGGER : 日志记录器
	  */
	private static final Logger LOGGER = LoggerFactory.getLogger(CollegeVo2EntityConverter.class);
	/**
