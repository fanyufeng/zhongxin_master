...
/**
  ...
  *
*/
public class EmployeeVo2EntityConverter implements Converter {
	...
	/**
	  * @Fields LOGGER : 日志记录器
	  */
	private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeVo2EntityConverter.class);
	/**
