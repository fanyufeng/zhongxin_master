package com.dongfang.client.zhongxin.leave.message.reply.vo;
 ...
 */
public class LeaveMessageReplyVO implements Serializable {
	...
	public String toString() {
		return "LeaveMessageReplyVO [id=" + id + ", leaveMessageId=" + leaveMessageId + ", replyContent=" + replyContent
