...
/**
  * @ClassName: ProjectClientEntity2VoConverter
  * @Description: 员工转换器，Entity->Vo
  * @author heliqiang@xbniao.com
  * @date 2016年2月5日 上午11:17:01
  *
*/
public class ProjectClientEntity2VoConverter implements Converter {
	...
	/**
	  * @Fields LOGGER : 日志记录器
	  */
	private static final Logger LOGGER = LoggerFactory.getLogger(ProjectClientEntity2VoConverter.class);
	/**
