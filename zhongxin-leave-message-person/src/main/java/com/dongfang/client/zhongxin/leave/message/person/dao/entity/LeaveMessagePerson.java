package com.dongfang.client.zhongxin.leave.message.person.dao.entity;
...
@Entity
@Table(name = "zhongxin_leave_message_person")
public class LeaveMessagePerson implements Serializable{
	...
	public String toString() {
		return "LeaveMessagePerson [id=" + id + ", personId=" + personId + ", commentContent=" + commentContent
