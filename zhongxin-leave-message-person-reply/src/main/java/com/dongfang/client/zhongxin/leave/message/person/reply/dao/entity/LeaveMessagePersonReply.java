package com.dongfang.client.zhongxin.leave.message.person.reply.dao.entity;
...
@Entity
@Table(name = "zhongxin_leave_message_person_reply")
public class LeaveMessagePersonReply implements Serializable{
	...
	@Column(name = "leave_message_person_reply_id", unique = true, nullable = false, length = 32)
	public String getId() {
		return id;
	}
	...
	@Column(name="leave_message_person_id")
	...
	public String toString() {
		return "LeaveMessagePersonReply [id=" + id + ", leaveMessagePersonId=" + leaveMessagePersonId
